...
class product{
    ...
    public function insert_product($data,$files){
        ...
        if($productQuantity=="" ||$productName=="" || $category=="" || $product_desc=="" || $price=="" || $type=="" || $file_name==""){
            $alert = "<span class = 'error'>Fields must be not empty</span>";
            return $alert;
        }else{
            move_uploaded_file($file_temp,$uploaded_image);
            $query = "INSERT INTO tbl_product(productQuantity,productName,catId,product_desc,price,type,image) VALUES('$productQuantity','$productName',
    ...
    public function update_product($data,$files,$id){
        ...
        if($productQuantity=="" ||$productName=="" || $category=="" || $product_desc=="" || $price=="" || $type==""){
            $alert = "<span class = 'error'>Fields must be not empty</span>";
            return $alert;
        }else{
            if(!empty($file_name)){
